...
plot(DT2, Global_active_power2, type = "n", ylab = "Global Active Power", xlab ="")
lines(DT2, Global_active_power2)
plot(DT2, hpc4$Voltage2, type = "n", ylab = "Voltage", xlab ="datetime")
lines(DT2, hpc4$Voltage2)
...
plot(DT2, hpc4$Global_reactive_power2, type = "n", ylab = "Global_reactive_power", xlab ="datetime")
lines(DT2, hpc4$Global_reactive_power2)
